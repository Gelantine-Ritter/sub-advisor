          ...
          <v-row center>
            <v-col cols="12" xs="12" sm="12" md="12" lg="8" xl="8">
              <div>
                ...
                euismod nisi porta lorem mollis. Ipsum nunc aliquet bibendum
                enim facilisis gravida neque. Sed augue lacus viverra vitae
                congue eu consequat. Proin sed libero enim sed faucibus turpis
                in eu. Diam maecenas ultricies mi eget mauris pharetra et
                ultrices neque. Scelerisque fermentum dui faucibus in. Luctus
                venenatis lectus magna fringilla urna porttitor rhoncus dolor
                purus. Elementum facilisis leo vel fringilla est ullamcorper.
                Donec ac odio tempor orci dapibus ultrices in iaculis. Sit amet
                risus nullam eget felis eget nunc. Ac turpis egestas integer
                eget aliquet nibh. Et tortor at risus viverra adipiscing at in
                tellus. Et tortor consequat id porta nibh venenatis. Sem nulla
                pharetra diam sit amet. Quis vel eros donec ac odio tempor orci
                dapibus. Consequat ac felis donec et odio pellentesque.
                <br /><br />
                Libero id faucibus nisl tincidunt eget nullam non. Est
                pellentesque elit ullamcorper dignissim cras tincidunt.
                Consectetur purus ut faucibus pulvinar elementum. Est velit
                egestas dui id ornare arcu. Egestas purus viverra accumsan in
                nisl nisi scelerisque. Nec ultrices dui sapien eget mi proin.
                Risus viverra adipiscing at in. Consectetur adipiscing elit duis
                tristique sollicitudin nibh sit amet commodo. Nunc sed velit
                dignissim sodales ut eu. Volutpat commodo sed egestas egestas
                fringilla phasellus. Elementum sagittis vitae et leo duis ut
                diam quam. Odio facilisis mauris sit amet massa vitae tortor.
              </div>
            </v-col>
            <!-- tags, price, ... -->
            <v-col
